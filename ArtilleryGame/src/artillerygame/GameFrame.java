...
public class GameFrame extends JFrame {
    ...
    public JPanel createGame() {
        ...
        worldView.setBorder(BorderFactory.createLineBorder(Color.BLACK));
        System.out.println(worldView.getWidth() + " " + worldView.getHeight());
        Game.add(worldView);
        return Game;
    }
    ...
    public void reset() {
        ...
        Terrain terrain = world.getModel().getTerrain();
    ...
    public void createButtonListeners(final JButton Save, final JButton Options) {
        ...
        Options.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                OptionFrame optf = new OptionFrame(world);
            }
        });
    }
